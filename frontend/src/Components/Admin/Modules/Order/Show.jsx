                ...
                <div className="col-md-6 col-lg-6 col-sm-12">
                    <div className="card">
                        ...
                        <div className="card-body">
                            ...
                            <span><strong>Payment Methood:  </strong>bkash</span><br />
                            <span><strong>Transection ID: </strong>{order.transection_id}</span><br />
                            {/* <span><strong>Total pay: </strong>{order.pay_id}</span><br /> */}
            ...
            <section>
                <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <tfoot className="my-4 float-right" >
                <br></br><b><h5>Total Amount : {total}Tk</h5></b>
                            </tfoot>
                    </div>
                </div>
            </section>
