            ...
            <div className="col-md-8 col-lg-8 col-sm-12">
              ...
              <form action="" onSubmit={Checkout}>
                <div className="row">
                  ...
                  <div className=" text-light p-2" style={{ borderRadius: "10px", background: "#fc5d35" }}>
       <h2 className="custom_heading">  
                 
                    <h6> Payment Here:  01780886577   (Bkash,Rocket,Nagud)</h6></h2>
       </div>
            ...
            <div className="col-md-4 col-lg-4 col-sm-12">
              ...
              {carts.map((cart, index) => (
                <div className="my-4">
                  <div className="col-md-12 col-lg-12 col-sm-12">
                    ...
                    <br />
                    <strong>
                     U_Price : {cart.product_id ? cart.product_id.price : ""}
                    </strong>
                    <br />
              ...
              <div class="d-flex">
                <div class="p-1 font-weight-bold"> Total: </div>
                <div class=" p-1 font-weight-bold">{total}Tk</div>
              </div>
            </div>
          </div>
        </div>
